import { getPipelineEnvVars, ENV_VARS_MAP, env } from "./env";
 ...
 */
export function getPipelineSource<TSources extends readonly CI_PIPELINE_SOURCE[] = readonly CI_PIPELINE_SOURCE[]>(...accepts: TSources): TSources[number] {
